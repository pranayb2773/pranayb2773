# Hi there, I'm Pranay! 👋
## 🚀 Full-Stack PHP Developer | Laravel & Symfony Specialist
> Building enterprise SaaS platforms for healthcare, financial services, and sales enablement with 7+ years of experience

### 💼 What I Do
- **7+ years** delivering enterprise SaaS platforms across **healthcare**, **financial services**, and **sales enablement**
- **Software Engineer at Bigtincan** - Developing backend services for Content Hub, an enterprise sales enablement platform
- **Platform migration expert** - Led complete migration from legacy Drupal/CiviCRM to Laravel 9/10 for UK mortgage professionals
- **Full-stack expertise** in PHP 8.x (Laravel 6-12, Symfony 4-6), Vue.js, React, TypeScript, and Livewire
- **API & Queue architecture** - Building RESTful APIs with OAuth 2.0, Redis caching, and AWS SQS message queues
- **Database optimization** - Query optimization, indexing, and schema normalization using EXPLAIN analysis
- **Agile practitioner** - Experienced working across UK, US, and Australian time zones in cross-functional teams
...
![PHPUnit](https://img.shields.io/badge/PHPUnit-3F9CD8?style=for-the-badge&logo=php&logoColor=white)
...
- **Bachelor of Science in Computer Science** - Lovely Professional University, India (2014-2018)
